 ...
 */
import {ChatMessage, LLMResponse, MessageRole, StreamOptions} from '../domain/llm/client';
import {ProcessorConfig, ProcessorRequest, ProcessorResponse} from './types';
import {buildConversationPrompt, ConversationContext} from '../domain/prompts/builders';
import { JobRequirement } from '../entities/job-requirement';
import { buildAnswerCriteriaSystemPrompt } from '../domain/prompts/builders/message-builders/requirements';
import { buildSystemMessage } from '../domain/prompts/builders/message-builders/message';
