...
export const routeRequirementState = async (
  ...
  if (needsClarification) {
    ...
    const clarificationNeeded = assistantMessage || 'Please provide more information to clarify your response.';
    ...
    const followUpMessage = processorResponse.assistantMessage;
    
    // Clean any JSON from the follow-up message
    const cleanFollowUpMessage = removeJSONFromText(followUpMessage);
