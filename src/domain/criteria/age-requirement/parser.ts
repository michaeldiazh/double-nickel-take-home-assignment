...
import {AgeRequirementValue, ageRequirementValueSchema} from './types';
...
/**
 * Extracts age requirement value from natural language text.
 * 
 * @param text - The text content to parse
 * @returns Age requirement value if found, null otherwise
 */
export const extractValueFromText = (text: string): AgeRequirementValue | null => {
...
/**
 * Parser context for age requirement requirements.
 */
export const ageRequirementParserContext: ParserContext<AgeRequirementValue> = {
