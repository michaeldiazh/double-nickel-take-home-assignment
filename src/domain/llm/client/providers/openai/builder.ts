...
/**
 * OpenAI usage metadata structure.
 */
...
/**
 * Checks if a model name is invalid.
 * 
 * @param model - Model name to validate
 * @returns true if model name is invalid, false otherwise
 */
const isInvalidModelName = (model: string | null | undefined): boolean => {
